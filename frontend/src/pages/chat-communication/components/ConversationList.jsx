...
const ConversationList = ({
  ...
  const formatLastMessageTime = (timestamp) => {
    ...
    return messageTime?.toLocaleDateString('en-IN', { month: 'short', day: 'numeric' });
  };
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-full p-8 text-center">
            ...
            <p className="text-text-secondary text-sm max-w-xs">
              {searchQuery
                ...
                : 'Start a conversation with a technician or user'}
            </p>
          </div>
        ) : (
          <div className="divide-y divide-border">
            {filteredConversations.map((conversation) => {
              ...
              const lastMessageSenderIsCurrentUser =
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        >
                          {lastMessageSenderIsCurrentUser && (
                            <span className="mr-1">
                      ...
                      {conversation?.participant?.role === 'technician' &&
                        conversation?.participant?.rating && (
                          <div className="flex items-center space-x-1 mt-1">
                            ...
                            <span className="text-xs text-text-secondary">
                              {conversation?.participant?.rating}
                              {conversation?.participant?.completedJobs != null && (
                                <>
                                  {' '}
                                  • {conversation?.participant?.completedJobs} jobs
                                </>
                              )}
                            </span>
                          </div>
